...
await orderService.ImportOrdersFromCsv(@"Resources/orders.csv");
...
var filteredOrders = orderService.GetFilteredOrders(district.Trim(), fromTime, toTime, minOrdersInDistrict);
